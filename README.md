...
A RAG fact-checking application that extracts verifiable claims from text and live audio, retrieves real evidence, and returns confidence-scored verdicts with citations.
